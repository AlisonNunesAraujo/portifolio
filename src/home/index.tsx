    ...
    <div className="conteiner">
      ...
      <div className="desc">
        <div>
          ...
          <h3 className="textDesc">
            ...
            <br />
            Android e Ios, e criação de sistemas web.
            <br />
      ...
      <div className="areaProjetos">
        <div>
          ...
          <p>
            Esse Aplicativo tem como objetivo ajudar as pessoas a gerenciar suas
            financas pessoais registrando seus gastos e receitas
          </p>
        ...
        <div>
          ...
          <p>
            Esse Aplicativo bem simples pode auxiliar na hora de fazer compras,
            podendo armazenar sua lista de compras
          </p>
          <a>Acessar</a>
        </div>
      </div>
