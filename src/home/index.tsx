        ...
        <div className="desc" id="sobre">
          ...
          <div>
            <h3 className="textDesc">
              Olá, meu nome é Alison Araújo! Eu sou desenvolvedor Mobile com
              React Native e tenho habilidades em desenvolvimento front-end
              também, atuo como desenvolvedor mobile! Gosto de construir
              ...
              e criação de sistemas web. Busco constantemente aprimorar minhas
              habilidades e melhorar meus conhecimentos.
            </h3>
          </div>
        </div>
